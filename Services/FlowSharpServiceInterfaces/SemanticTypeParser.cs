...
namespace FlowSharpServiceInterfaces
{
    public static class SemanticTypeParser
    {
        ...
        private static readonly Dictionary<string, string> CommandAliases = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { CanonicalizeCommandKey("setshapeproperty"), "CmdSetShapeProperty" },
            { CanonicalizeCommandKey("setproperty"), "CmdSetShapeProperty" },
            ...
            { CanonicalizeCommandKey("renderprintpage"), "CmdRenderPrintPage" },
            ...
            { CanonicalizeCommandKey("dragselection"), "CmdDragSelection" },
            { CanonicalizeCommandKey("alignselection"), "CmdAlignSelection" },
            { CanonicalizeCommandKey("align"), "CmdAlignSelection" },
            { CanonicalizeCommandKey("rotateselection"), "CmdRotateSelection" },
            { CanonicalizeCommandKey("rotate"), "CmdRotateSelection" },
            ...
            { CanonicalizeCommandKey("regroupselection"), "CmdRegroupSelection" },
            { CanonicalizeCommandKey("regroup"), "CmdRegroupSelection" },
            ...
            { CanonicalizeCommandKey("convertconnector"), "CmdConvertConnector" },
            { CanonicalizeCommandKey("removediagonalconnectors"), "CmdRemoveDiagonalConnectors" },
            { CanonicalizeCommandKey("setcustomconnectionpoints"), "CmdSetCustomConnectionPoints" },
